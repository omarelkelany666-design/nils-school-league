...
if matches_time:
    ...
    matches_time_choose = option_menu(
        menu_title="select prep you want",
        options=["جدول المبريات(النتائجوالمواعيد)", "جدول المبريات (تابع)"],
        default_index=0,
        orientation="horizontal",
    )
    if matches_time_choose=="جدول المبريات(النتائجوالمواعيد)":
        matches_table = pd.DataFrame(

            {
                ...
                "team(1)": [
                    "1B", "1C", "1D", "2A", "2B","2C" ,"2D" ,"1C" ,"1D" ,"2A" ,"2B" ,"2C" ,"2D" ,"1D"
                ],

                "team(2)": [
                    "1A", "1A", "1A", "1A", "1A","1A" ,"1A" ,"1B" ,"1B" ,"1B" ,"1B" ,"1B" ,"1B" ,"1C"
                ]
            }
        )


        st.header("جدول المبريات(النتائجوالمواعيد)")
    ...
    #choose prep1#
    #==================================#
    if matches_time_choose=="جدول المبريات (تابع)":
        matches_table = pd.DataFrame(
            {
                "":[
                ...
                "team(1)": [
                    "2A", "2B", "2C", "2D", "2A","2B" ,"2C" ,"2D" ,"2B" ,"2C" ,"2B" ,"2C" ,"2D" ,"2D"
                ],

                "team(2)": [
                    "1C", "1C", "1C", "1C", "1D","1D" ,"1D" ,"1D" ,"2A" ,"2A" ,"2A" ,"2B" ,"2B" ,"2C"
                ]
            }
        )


        st.header("جدول المبريات (تابع)")
